...
description: 'Connect with verified professionals for all your household needs. Choose from Basic or Premium Plan.',
    ...
    if (isInBC && userCity) {
      return {
        ...
        subheadline: 'Our Expertise',
description: `Connect with verified professionals for all your household needs across ${userCity} and the Lower Mainland. Choose from Basic or Premium Plan.`,
    ...
    if (isInBC) {
      return {
        ...
        subheadline: 'Our Expertise',
description: 'Connect with verified professionals for all your household needs across British Columbia. Choose from Basic or Premium Plan.',
