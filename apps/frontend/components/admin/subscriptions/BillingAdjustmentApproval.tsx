...
export function BillingAdjustmentApproval({ onRefresh }: BillingAdjustmentApprovalProps) {
  ...
  const fetchAdjustments = async () => {
    try {
      ...
      const response = await request(`/api/admin/subscriptions/billing-adjustments?${params}`);
  ...
  const handleApprove = async () => {
    ...
    try {
      ...
      const response = await request(`/api/admin/subscriptions/billing-adjustments/${selectedAdjustment.id}/approve`, {
        method: 'POST',
  ...
  const handleReject = async () => {
    ...
    try {
      setProcessingId(selectedAdjustment.id);
      const response = await request(`/api/admin/subscriptions/billing-adjustments/${selectedAdjustment.id}/reject`, {
        method: 'POST',
