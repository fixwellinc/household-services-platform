...
export default function LocationPromptModal({ 
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-end justify-center z-50 p-4 overflow-y-auto">
      <div className="bg-white rounded-lg shadow-xl max-w-md w-full relative mb-16">
        {/* Close Button */}
        <button
          onClick={onClose}
