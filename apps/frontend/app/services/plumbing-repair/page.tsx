...
export const metadata: Metadata = {
  title: 'Plumbing Repair - Fixwell',
  description: 'Expert plumbing repair services with licensed professionals and emergency availability',
};
                ...
                <div className="bg-gradient-to-br from-blue-50 to-purple-50 rounded-2xl p-8 shadow-lg">
                  ...
                  <div className="bg-white rounded-lg p-6 mb-6">
                    <div className="flex items-center justify-between mb-4">
                      ...
                      <span className="text-lg line-through text-red-600 font-medium">$250</span>
                    </div>
                    <div className="flex items-center justify-between mb-4">
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <span className="text-lg font-bold text-green-600">$70 (28%)</span>
                    </div>
                  </div>
